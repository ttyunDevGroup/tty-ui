<template>
  <div class="t-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <t-scrollbar
      @mouseenter.native="emitSelectRange('hours')"
      class="t-time-spinner__wrapper"
      wrap-style="max-height: inherit;"
      view-class="t-time-spinner__list"
      noresize
      tag="ul"
      ref="hour">
      <li
