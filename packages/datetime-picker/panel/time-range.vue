<template>
  <transition name="b-zoom-in-top" @before-enter="panelCreated" @after-leave="$emit('dodestroy')">
    <div v-show="visible" :style="{ width: width + 'px' }" class="t-time-range-picker t-picker-panel" :class="popperClass">
      <div class="t-time-range-picker__content">
        <div class="t-time-range-picker__cell">
          <div class="t-time-range-picker__header">开始时间</div>
          <div :class="{ 'has-seconds': showSeconds }" class="t-time-range-picker__body t-time-panel__content">
        ...
        </div><div class="t-time-range-picker__cell">
          <div class="t-time-range-picker__header">结束时间</div>
          <div :class="{ 'has-seconds': showSeconds }" class="t-time-range-picker__body t-time-panel__content">
      ...
      <div class="t-time-panel__footer">
        <button type="button" class="t-time-panel__btn cancel" @click="handleCancel()">取消</button>
        <button type="button" class="t-time-panel__btn confirm" @click="handleConfirm()" :disabled="btnDisabled">确定</button>
      </div>
    </div>
  </transition>
</template>
